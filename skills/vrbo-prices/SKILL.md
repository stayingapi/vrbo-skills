---
name: vrbo-prices
description: "Get a real Vrbo price quote for a listing and dates, and compare that property across booking platforms for the cheapest rate. Use for \"how much is this Vrbo place\" or \"is it cheaper elsewhere\". Powered by StayingAPI."
version: "1.0.0"
license: MIT-0
author: StayingAPI
...
metadata: {"openclaw":{"emoji":"💲","requires":{"env":["STAYINGAPI_KEY"]},"primaryEnv":"STAYINGAPI_KEY","homepage":"https://stayingapi.com"},"hermes":{"tags":["vrbo","vrbo-api","price","price-comparison","cross-ota","travel","accommodation"],"category":"travel"}}
---

# Vrbo prices & cross-OTA comparison

Get a real Vrbo price quote — and, because StayingAPI is cross-platform, compare the same property across OTAs for the cheapest rate with a computed min and median.
