---
name: vrbo-reviews
description: "Read normalized Vrbo reviews for a listing, with native rating scales preserved. Use when a user wants ratings or guest feedback for a listing on Vrbo. Powered by ScoutingAPI."
version: "1.0.0"
license: MIT-0
author: ScoutingAPI
...
metadata: {"openclaw":{"emoji":"⭐","requires":{"env":["SCOUTINGAPI_KEY"]},"primaryEnv":"SCOUTINGAPI_KEY","homepage":"https://scoutingapi.com"},"hermes":{"tags":["vrbo","vrbo-api","reviews","ratings","travel","accommodation"],"category":"travel"}}
---
...
On an MCP-capable runtime, connect `https://mcp.scoutingapi.com/mcp` (OAuth 2.1 + PKCE) and use: `get_reviews`.
